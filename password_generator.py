...
class PasswordGenerator(QMainWindow):
    def __init__(self):
        ...
        # Create the save, view, and copy buttons
        ...
        self.copy_button.setStyleSheet("background-color: #FF9800; color: white;")
    ...
    def save_password(self):
        ...
        file_path = r"H:\PROJECTS\Byte-N-Crypt-main\toolkit\pass.txt.txt"
    ...
    def copy_password(self):
        ...
        if len(password) == 0:
            QMessageBox.warning(self, "Warning", "No password generated to copy.")
            return

        # Access the clipboard from the QApplication instance
